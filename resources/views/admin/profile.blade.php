...
@push('style')
    <link href="{{ URL::asset('assets/admin/Image-preview/dist/css/bootstrap-imageupload.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/admin/jcropper/css/cropper.min.css') }}" rel="stylesheet">
@endpush
@section('content')
    <div class="">
...
@push('js')
    ...
    <script src="{{ URL::asset('assets/admin/jcropper/js/cropper.min.js') }}"></script>
    <script src="{{URL::asset('assets/js/profile/image-crop.js')}}"></script>
    <script src="{{URL::asset('assets/js/profile/profile-validation.js')}}"></script>
    <script src="{{URL::asset('assets/js/profile/change-password-validation.js')}}"></script>
@endpush
