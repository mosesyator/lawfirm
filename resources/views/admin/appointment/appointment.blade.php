...
@push('style')
    <link rel="stylesheet" type="text/css"
          href="{{URL::asset('assets/admin/jquery-confirm-master/css/jquery-confirm.css')}}">
...
@push('js')
    <script type="text/javascript" src="{{URL::asset('assets/admin/jquery-confirm-master/js/jquery-confirm.js')}}"></script>
    <script src="{{URL::asset('assets/js/appointment/appointment-datatable.js')}}"></script>
@endpush
