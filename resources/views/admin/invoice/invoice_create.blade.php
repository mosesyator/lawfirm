...
@section('content')
    <link href="{{URL::asset('assets/css/invoice_css.css') }}" rel="stylesheet">

    <form class="repeater" id="add_invoice" name="add_invoice" role="form" method="POST"
          action="{{route('store_invoice')}}" autocomplete="off">
                            ...
                            <div class="table-responsive">
                                <table class="table tableInv" id="purchaseInvoice" data-repeater-list="invoice_items">
                                    ...
                                    <tr class="tbl_header_color dynamicRows">
                                        ...
                                        <th class="hide with_tax" width="10%" class="text-center">Tax (Ksh)</th>
...
@push('js')
    ...
    <script src="{{URL::asset('assets/js/invoice/invoice-validation.js')}}"></script>


    <script src="{{URL::asset('assets/admin/js/repeter/repeatercustome.js') }}"></script>
    <script src="{{URL::asset('assets/admin/js/repeter/invoice-add-datatable.js') }}"></script>
