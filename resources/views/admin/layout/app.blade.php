...
<head>
    ...
    <link href="{{URL::asset('assets/admin/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')}}"
          rel="stylesheet">
    <!-- Font Awesome -->
...
<!-- bootstrap-progressbar -->
    <link href="{{URL::asset('assets/admin/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }}"
          rel="stylesheet">
    <!-- bootstrap-daterangepicker -->
    <link href="{{URL::asset('assets/admin/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css') }}"
          rel="stylesheet"/>
    <!-- Custom Theme Style -->
    ...
    <link href="{{ URL::asset('assets/admin/vendors/bootstrap-datepicker/css/bootstrap-datepicker.css') }}" rel="stylesheet">
                    ...
                    <div class="profile_pic">
                        @if(Auth::guard('admin')->user())
                            @if(Auth::guard('admin')->user()->profile_img!="")
                             ...
                             img src="{{asset(config('constants.CLIENT_FOLDER_PATH') .'/'. Auth::guard('admin')->user()->profile_img)}}">
                            @else
...
<!-- FastClick -->
<script src="{{URL::asset('assets/admin/vendors/fastclick/lib/fastclick.js') }}"></script>
<!-- NProgress -->
<script src="{{URL::asset('assets/admin/vendors/nprogress/nprogress.js') }}"></script>
<!-- bootstrap-progressbar -->
<script src="{{URL::asset('assets/admin/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js') }}"></script>
<!-- DateJS -->
<script src="{{URL::asset('assets/admin/vendors/DateJS/build/date.js') }}"></script>
<!-- bootstrap-daterangepicker -->
<script src="{{URL::asset('assets/admin/vendors/moment/min/moment.min.js') }}"></script>
<script src="{{ URL::asset('assets/admin/js/sweetalert2.all.min.js') }}"></script>
<!-- Custom Theme Scripts -->
<script src="{{URL::asset('assets/admin/build/js/custom.js') }}"></script>
...
<script
        src="{{URL::asset('assets/admin/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')}}"></script>
<script src="{{ URL::asset('assets/admin/js/jquery.validate.min.js') }}"></script>

<script src="{{URL::asset('assets/admin/vendors/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}"></script>
