...
@push('js')
    ...
    <script src="{{URL::asset('assets/admin/vendors/repeter/repeater.js')}}"></script>
    <script src="{{URL::asset('assets/admin/vendors/jquery-ui/jquery-ui.js') }}"></script>
    <script src="{{URL::asset('assets/js/client/add-client-validation.js')}}"></script>
@endpush
