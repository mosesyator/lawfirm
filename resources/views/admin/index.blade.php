...
@section('content')
    ...
    @if($adminHasPermition->can(['dashboard_list']))
        ...
        <link href="{{ URL::asset('assets/admin/vendors/fullcalendar/dist/fullcalendar.min.css') }} " rel="stylesheet">
...
@push('js')
    ...
    <script src="{{ URL::asset('assets/admin/vendors/fullcalendar/dist/fullcalendar.min.js') }}"></script>
    <script src="{{URL::asset('assets/js/dashbord/dashbord-datatable.js')}}"></script>
@endpush
